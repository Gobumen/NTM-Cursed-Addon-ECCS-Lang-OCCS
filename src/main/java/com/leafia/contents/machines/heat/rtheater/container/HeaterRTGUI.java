...
public class HeaterRTGUI extends GuiInfoContainer {

	private static ResourceLocation texture = new ResourceLocation("leafia" + ":textures/gui/heat/gui_heater_rtg.png");
	private HeaterRTGTE heater;
	
	public HeaterRTGUI(InventoryPlayer invPlayer,HeaterRTGTE tedf) {
		super(new HeaterRTGContainer(invPlayer, tedf));
		heater = tedf;
	...
	public void drawScreen(int mouseX, int mouseY, float f) {
		...
		this.drawCustomInfoStat(mouseX, mouseY, guiLeft + 152, guiTop + 69 + 4 - 52, 16, 52, mouseX, mouseY, new String[]{String.format("%,d", Math.min(heater.heatEnergy, HeaterRTGTE.maxHeatEnergy)) + " / " + String.format("%,d", HeaterRTGTE.maxHeatEnergy) + " TU"});
